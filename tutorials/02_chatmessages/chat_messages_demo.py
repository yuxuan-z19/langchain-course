...
def demonstrate_conversation_flow():
    ...
    user_question = HumanMessage(
        content="什么是Python中的列表推导式？能给个例子吗？"
    )
...
def demonstrate_function_message_simulation():
    ...
    try:
        ...
        # 模拟基于函数结果的AI回复
        print("\n🤖 基于函数结果的AI回复示例:")
        print(f"根据系统时间，现在是 {function_result['result']} ({function_result['timezone']} 时区)")
